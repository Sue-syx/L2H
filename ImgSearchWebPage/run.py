...
def load_config():
    ...
    parser.add_argument('--dataset', default='nus-wide-tc21', type=str,
                        help='Dataset name.')
    parser.add_argument('--root', default='../datasets/NUS-WIDE', type=str,
                        help='Path of dataset')
    parser.add_argument('--batch-size', default=64, type=int,
                        help='Batch size.(default: 64)')
    parser.add_argument('--lr', default=1e-4, type=float,
                        help='Learning rate.(default: 1e-4)')
    # parser.add_argument('--code-length', default='24,32,48', type=str,
    #                     help='Binary hash code length.(default: 24,32,48)')
    parser.add_argument('--code-length', default='24', type=str,
                        help='Binary hash code length.(default: 24,32,48)')
